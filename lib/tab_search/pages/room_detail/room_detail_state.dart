...
class RoomDetailState {
  ...
  RoomDetailState() {
    ...
    final TabHomeLogic logic = Get.find<TabHomeLogic>();
    final TabHomeState state = logic.state;
    infoItems = state.infoItems;
     isShowTextTool= data.subTitle!.length > 100; //文字长度低于100隐藏底部工具栏
    isCollected = true;
  }
}
